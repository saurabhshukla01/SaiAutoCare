...
class CustomerController extends Controller 
{
   public function __construct()
    ...
    public function save(Request $request, $id = null)
    {
		...
		return view('SaiAutoCare.customer', $viewData)->with($getFormAutoFillup);
    }
...
// exit;
		    ...
		    return view('SaiAutoCare.customer', $viewData);
    ...
    public function trashedList()
    {
         ...
         return view('SaiAutoCare.customer.delete', compact('TrashedParty', 'TrashedParty')); 
    }
    public function permanemetDelete(Request $request,$id)
    {
    	...
    	if(($id!=null) && (Customer::where('id',$id)->forceDelete())){
    	 ...
    	 $TrashedParty = Customer::orderBy('deleted_at', 'desc')->onlyTrashed()->simplePaginate(10);
         return view('SaiAutoCare.customer', compact('TrashedParty', 'TrashedParty'));
    }
}
