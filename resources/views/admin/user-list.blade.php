                ...
                <tr>
                  ...
                  <td style="white-space: nowrap">
                   <a href="{{ url('/')}}/employee-edit/{{ $value['UserId'] }}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a> 
                    {{--  <a style="dispay:none" href="{{ url('/')}}/SaiAutoCare/product/trash/{{ $value['UserId']}} " class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this user?');"><i class="fa fa-remove"></i></a> --}}
                  </td>
                </tr>  
                @endforeach
              </tbody>
