...
<div class="card border-info">
  {{ isset($id)?Form::open(['url' => 'SaiAutoCare/sale/update','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) : Form::open(['url' => 'SaiAutoCare/sale/create','files' => 'true' ,'enctype' => 'multipart/form-data', 'autocomplete' => 'OFF']) }}
   {{ csrf_field() }}
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-{{ session('message.level') }} alert-dismissible" onload="javascript: Notify('You`ve got mail.', 'top-right', '5000', 'info', 'fa-envelope', true); return false;">
              ...
              @if(isset($id))
              <div class="text-center text-primary"><a  target="blank" href="{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($id) ? $id : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                   var newTab = window.open("{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($id) ? $id : '' }}", "_blank");
                      newTab.location;
              ...
              @else
               <div class="text-center text-primary"><a target="blank" href="{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($workshopId) ? $workshopId : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                 $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
                    var newTab = window.open("{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($workshopId) ? $workshopId : '' }}", "_blank");
                      newTab.location;
                   console.log("Worshop Detail Opened In New Tab");
                  },1000)
                })
