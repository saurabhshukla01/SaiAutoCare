        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <div class="alert alert-{{ session('message.level') }} alert-dismissible" onload="javascript: Notify('You`ve got mail.', 'top-right', '5000', 'info', 'fa-envelope', true); return false;">
              ...
              @if(isset($id))
              <div class="text-center text-primary"><a id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($id) ? $id : '' }}">Show Detail</a></div>
              ...
              @else
               <div class="text-center text-primary"><a  id="openWorkshopDetail"  target="blank" href="{{url('/')}}/SaiAutoCare/workshop/view/{{ isset($workshopId) ? $workshopId : '' }}">Show Detail</a></div>
                <script type="text/javascript">
                 $(document).ready(function(){
                  setTimeout(function(){
                   $('#openWorkshopDetail').trigger('click');
